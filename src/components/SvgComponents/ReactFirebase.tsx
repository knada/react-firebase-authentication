...
const ReactFirebase = ({ animation }: ReactFirebaseProps) => (
    <ReactFirebaseSvg animation={animation} viewBox="1.008 18.463 180 160.509">
        <title>{'React-Firebase logo'}</title>
